(function () {
	...
	// --- Kontaktformular per fetch() an Web3Forms (kein eigener Server auf GitHub Pages) ---
	...
	if (form) {
		form.addEventListener("submit", function (event) {
			...
			// Eigenes Honeypot-Feld: Bots, die alle Felder blind ausfüllen, bekommen einen
			// stillen "Erfolg" ohne dass überhaupt eine Anfrage rausgeht.
